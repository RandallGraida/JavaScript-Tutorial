/*
* HTMLHttpRequest
* - Built-in class. Creates a new HTTP message to send to the backend
* GET 
* - get some information from the backend
* URL 
* - address for the internet, locate other computer/server from the internet
* ex. https://amazon.com
